...
Frozen snapshot of the AERIS code used for the 2025 ACM Gordon Bell Prize for Climate Modeling submission. This repository is provided as a reference and is not intended for direct use. The code has been cleaned and unrelated experiments have been removed but has not been tested after cleanup.

## Configurations

- **Benchmark**: Minimal startup overhead with most performant settings
- **Train**: Full training setup used for most science results with conservative performance optimizations for long-term stability
